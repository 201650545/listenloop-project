...
| **课程取源通道 / YouTube 中继** | `EPIC-02` | [creation_controller.dart](../../code/lib/creation/creation_controller.dart) + `tool/youtube_relay.py` + `tool/start_youtube_relay.ps1` | [11_课程取源通道与YouTube中继运维.md](../02_%E5%B7%A5%E7%A8%8B%E6%9E%B6%E6%9E%84%E4%B8%8E%E7%B3%BB%E7%BB%9F%E8%AE%BE%E8%AE%A1/11_%E8%AF%BE%E7%A8%8B%E5%8F%96%E6%BA%90%E9%80%9A%E9%81%93%E4%B8%8EYouTube%E4%B8%AD%E7%BB%A7%E8%BF%90%E7%BB%B4.md) |
...
- ✅ **2026-09-25 EPIC-04 推进**：弱项优先复习排序落地（07 §三.2 → Item 级实现，10 号文档 §十七）——队列按「SRS 遗忘 + ease 低 + 练习失败 × 拖欠权重」排序，弱项先占配额；全量测试 482 项通过。
- ✅ **2026-09-25 EPIC-04 补完**：AI 出题第 3 题（冲突消解）落地（10 号 §5.2）——两题证据冲突时出对比/纠错任务，通过即升「会」；10 号 §十八。**新增 13 号设计裁决稿**（词形归并，四项待拍板）；全量测试 511 项通过。
- ✅ **2026-09-25 lemma 归并落地**（13 号四项按推荐拍板，方案 A）：三层还原器 + 全库统一归并键 ocabularyMergeKey + 启动时自动迁移（快照兜底）；phrase 独立键空间。全量测试 551 项通过。
